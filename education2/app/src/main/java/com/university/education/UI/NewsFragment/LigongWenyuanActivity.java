...
public class LigongWenyuanActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        newsModule.getPerfectArticle("http://www.sylu.edu.cn/sylusite/lgwy/", new NewsModule.NewsResponseListener() {
            @Override
