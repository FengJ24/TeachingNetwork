...
public class GradeChooseYearAdapter extends MyBasicAdapter<ClassTableChooseBean> {
    ...
    public GradeChooseYearAdapter(List<ClassTableChooseBean> list, GradeChooseXuenianXueqiView gradeChooseXuenianXueqiView, Context context) {
        super(list);
        mGradeChooseXuenianXueqiView = gradeChooseXuenianXueqiView;
        mContext = context;
    ...
    public void showData(final int position, Object holder, final List<ClassTableChooseBean> adapterList) {
        ...
        viewHolder.tv_grade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mGradeChooseXuenianXueqiView.callnotifyDataSetChanged(adapterList.get(position).getName());
