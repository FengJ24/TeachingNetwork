...
public class GradeChooseTermAdapter extends BaseAdapter {
    private Drawable drawableItem2;
    private List<ClassTableChooseBean> list;
    private GradeChooseXuenianXueqiView gradeChooseXuenianXueqiView;
    private Context mContext;
    private Drawable drawableItem;
    private ViewHolder viewHolder;
    private boolean isAllCheck = false;

    public GradeChooseTermAdapter(List<ClassTableChooseBean> list, GradeChooseXuenianXueqiView gradeChooseXuenianXueqiView, Context context) {
        super();
        this.list = list;
        this.gradeChooseXuenianXueqiView = gradeChooseXuenianXueqiView;
        mContext = context;
        if (list.size() == 3) {
            list.remove(2);
        }
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_subject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gradeChooseXuenianXueqiView.callSubjectDataChanged(list.get(position).getName());
