...
public class LigongFengcaiActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        newsModule.getPerfectArticle("http://www.sylu.edu.cn/sylusite/lgfc/", new NewsModule.NewsResponseListener() {
            @Override
