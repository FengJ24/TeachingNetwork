...
public class UniversityCultureActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        newsModule.getPerfectArticle("http://www.sylu.edu.cn/sylusite/dxwh/", new NewsModule.NewsResponseListener() {
            @Override
